...
public sealed partial class NanoChatUiFragment : BoxContainer
{
    ...
    private void SetupEventHandlers()
    {
        ...
        SendCoinButton.OnPressed += _ => OpenCoinTransferDialog(); // Reserve add
    ...
    // Reserve edit start
    private void OpenCoinTransferDialog()
    {
        var activeChat = _pendingChat ?? _currentChat;
        if (activeChat == null)
            return;

        var dialog = new CoinTransferDialog();
        dialog.OnCoinTransfer += amount =>
        {
    ...
    private void UpdateMessages(Dictionary<uint, List<NanoChatMessage>> messages)
    {
        ...
        foreach (var message in chatMessages)
        {
            ...
            MessageList.AddChild(new Control { MinSize = new Vector2i(0, 4) });
        }
