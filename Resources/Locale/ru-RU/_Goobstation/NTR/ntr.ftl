...
ntr-executive-softsuit-name = Заказать базовый костюм EVA
ntr-executive-softsuit-desc = Базовый костюм EVA, предназначенный для кратковременного пребывания в космосе. Обеспечивает минимальную защиту.
ntr-executive-hardsuit-name = Заказать костюм EVA
ntr-executive-hardsuit-desc = Прочный костюм EVA для экстремальных условий. Вы уверены, что эта покупка оправдана?
