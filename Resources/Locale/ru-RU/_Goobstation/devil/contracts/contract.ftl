...
default-contract-content = Это обязательный к исполнению контракт, заключенный в этот день между:
    ...
    { "[" }выделено жирным] Положения, имеющие обязательную силу:{ "[" }/выделено жирным шрифтом]
    { "[" }курсив] Следующие стороны отказываются от следующего имущества{ "[" }/курсив{ "]" }

    Получатель контракта: Владение душой
    Получатель контракта: Смерть

    { "[" }курсив] Все пункты вступают в силу с момента подписания настоящего документа обеими сторонами.{ "[" }/курсив]
    { "[" }выделенный курсивом]{ "[" }color=#ac3a0d]Условия не могут быть нарушены. Когда-либо.{ "[" }/цвет]{ "[" }/курсив]
