...
uplink-signaller-desc = Устройство, которое может подавать сигналы на любом расстоянии. Вы можете соединять предметы с помощью мультитула или конфигуратора сети.
...
uplink-heavensgate-name = Врата рая
uplink-heavensgate-desc = Старая противотанковая винтовка, используемая лучшими бойцами Синдиката. Поставляется с двумя типами боеприпасов: бронебойными для борьбы с пехотой и противотанковыми для борьбы со строениями.
...
uplink-92-AP-name = Коробка с бронебойными патронами .92
uplink-92-AP-desc = 10 бронебойных патронов .92 для снайперской винтовки "Врата рая". Эффективны для борьбы с пехотой.

uplink-92-AT-name = Коробка противотанковых патронов .92
uplink-92-AT-desc = 10 противотанковых патронов .92 для снайперской винтовки "Врата рая". Эффективны для борьбы со структурами.
