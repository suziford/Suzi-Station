...
uplink-heavensgate = Старая противотанковая винтовка, используемая лучшими бойцами Синдиката. Поставляется с двумя типами боеприпасов: бронебойными для борьбы с пехотой и противотанковыми для борьбы со строениями.
