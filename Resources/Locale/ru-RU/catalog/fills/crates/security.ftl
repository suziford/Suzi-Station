...
ent-CrateSecNonlethalThrowables = ящик нелетальных гранат
    .desc = Содержит по одной коробке светошумовых гранат, осколочных гранат, гранат со слезоточивым газом и четыре болы. Чтобы открыть необходим уровень доступа Служба безопасности.
