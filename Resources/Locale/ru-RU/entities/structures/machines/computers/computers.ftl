...
ent-ComputerShuttleSalvage = консоль шаттла утилизаторов
    .desc = Используется для пилотирования шаттла утилизаторов.
...
ent-ComputerFundingAllocation = консоль распределения доходов
    .desc = Терминал для контроля распределения денежных средств и оплаты труда по отделам.
