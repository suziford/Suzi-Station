...
ent-PosterContrabandExoAcid = Остережение Экзоморфов: Кислотный плевок!
    .desc = Этот плакат предупреждает вас о кислотной слюне экзоморфа. Не то чтобы такие экзоморфы существовали на самом деле... Верно?
ent-PosterContrabandExoRun = Остережение Экзоморфов: Убегайте!
    .desc = Этот плакат предупреждает вас о спортивном экзоморфе, способном утащить любого, кто попадется, так что не попадайтесь!
ent-PosterContrabandExoChomp = Остережение Экзоморфов: Мощные укусы!
    .desc = Этот плакат предупреждает вас о смертельных укусах экзоморфов. Не становитесь закуской для инопланетян!
# legit
