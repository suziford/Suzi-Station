...
ent-AtmosMonitoringComputerCircuitboard = плата для монитора атмосферной сети
...
ent-CargoRequestEngineeringComputerCircuitboard = консоль инженерных запросов (консольная плата)
    .desc = Консольная плата для консоли инженерных запросов.
ent-CargoRequestMedicalComputerCircuitboard = консоль медицинских запросов (консольная плата)
    .desc = Консольная плата для консоли медицинских запросов
ent-CargoRequestScienceComputerCircuitboard = консоль научных запросов (консольная плата)
    .desc = Консольная плата для консоли научных запросов.
ent-CargoRequestSecurityComputerCircuitboard = консоль запросов службы безопасности (консольная плата)
    .desc = Консольная плата для консоли запросов службы безопасности.
ent-CargoRequestServiceComputerCircuitboard = консоль сервисных запросов (консольная плата)
    .desc = Консольная плата для консоли сервисных запросов.
ent-FundingAllocationComputerCircuitboard = консоль распределения доходов (консольная  плата)
    .desc = Консольная плата для консоли распределения доходов.
