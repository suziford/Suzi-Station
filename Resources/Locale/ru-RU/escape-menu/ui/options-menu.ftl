...
ui-options-function-toggle-standing = Ползти/стоять
...
# Goobstation - Extra hotbar hotkeys
ui-options-function-loadoutshift1 = Лодаут Хотбара Shift+1
ui-options-function-loadoutshift2 = Лодаут Хотбара Shift+2
ui-options-function-loadoutshift3 = Лодаут Хотбара Shift+3
ui-options-function-loadoutshift4 = Лодаут Хотбара Shift+4
ui-options-function-loadoutshift5 = Лодаут Хотбара Shift+5
ui-options-function-loadoutshift6 = Лодаут Хотбара Shift+6
ui-options-function-loadoutshift7 = Лодаут Хотбара Shift+7
ui-options-function-loadoutshift8 = Лодаут Хотбара Shift+8
ui-options-function-loadoutshift9 = Лодаут Хотбара Shift+9
ui-options-function-loadoutshift0 = Лодаут Хотбара Shift+0
