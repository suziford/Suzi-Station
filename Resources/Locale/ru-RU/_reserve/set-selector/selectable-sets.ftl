...
selectable-set-paramedic-modsuit-desc =
    Модульный комбинезон с более тяжелыми пластинами.
    чтобы, надеюсь, все же отразить пару пуль.

selectable-set-security-voidsuit-name = Охранный скафандр
selectable-set-security-voidsuit-desc =
    Легкий скафандр со встроенным держателем для пластин, обеспечивающий
    умеренную защиту, оставаясь мобильным для боевых операций низкой интенсивности.

selectable-set-security-modsuit-name = Охранный модсьют 'Борац'
selectable-set-security-modsuit-desc =
    Модульный комбинезон с керамическими вставками, обеспечивающий большую защиту
    чем у скафандра, но с меньшей мобильностью.
...
selectable-set-headofsecurity-voidsuit-desc =
    ...
    бронирование жизненно важных органов, при этом мобильность выше,
    по сравнению со стандартным защитным модсьютом.
...
selectable-set-headofsecurity-modsuit-desc =
    Модульный скафандр с дорогой пластитановой броней для использования главой службы безопасности.
    Оснащен бортовым инъектором внутривенной стимуляции с ручным управлением

selectable-set-engineering-voidsuit-name = Инженерный скафандр
selectable-set-engineering-voidsuit-desc =
    Легкий скафандр для проведения малоинтенсивных ремонтных работ на станции

selectable-set-engineering-modsuit-name = Инженерный модсьют "Сапер"
selectable-set-engineering-modsuit-desc =
    Модульный скафандр с усиленной защитой от взрывов, а большой уязвимый визор
...
selectable-set-captain-voidsuit-desc =
    Легкий скафандр капитана, сшитый на заказ для официальных случаев, слегка
    бронированный для защиты во время обычной смены, сохраняя при этом
    обычные возможности выхода в открытый космос.

selectable-set-captain-modsuit-name = Капитанский модсьют "Магнат"
selectable-set-captain-modsuit-desc =
    Модульный комбинезон с идеальным блеском, украшениями и броней для лучших из лучших.
    Оснащен специальным покрытием, охлаждающей жидкостью и бриллиантами, чтобы
