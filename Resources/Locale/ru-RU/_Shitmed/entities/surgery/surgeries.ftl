...
ent-SurgeryStopBloodOutput = Остановите постоянный выброс крови
    .desc = { ent-SurgeryBase.desc }
ent-SurgeryFixDismemberment = Исправьте остатки расчленения
    .desc = { ent-SurgeryBase.desc }
...
ent-SurgeryMendBones = Срастить кости
    .desc = { ent-SurgeryBase.desc }
ent-SurgeryHealOrgans = Исцелять органы
    .desc = { ent-SurgeryBase.desc }
ent-SurgeryAttachHead = Присоединить голову
    .desc = { ent-SurgeryBase.desc }
ent-SurgeryAttachGroin = Прикрепите пах
    .desc = { ent-SurgeryBase.desc }
