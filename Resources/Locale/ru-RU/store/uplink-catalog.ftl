...
uplink-chemistry-kit-desc = Стартовый набор для начинающего химика включает в себя химический заряд и таймер, шприц с гиперзином и два флакона с вестином для всех ваших преступных нужд!
uplink-dart-syringe-gun-name = Пистолет со шприцем для дротиков
uplink-dart-syringe-gun-desc = Пистолет, который принимает шприцы в качестве боеприпасов и впрыскивает их содержимое своим жертвам. Может пробивать броню.
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Этот имеет дополнительную перепонку и термостойкие волокна.
...
uplink-fake-mindshield-name = Имплант поддельной защиты разума
uplink-fake-mindshield-desc = Переключаемый имплант, способный имитировать те же сигналы, что и у настоящего импланта защиты разума, когда он включен, и обманывать дисплеи, заставляя их думать, что у вас есть защита разума (имплант марки Nanotrasen в комплект поставки не входит).
uplink-contraband-lighter-name = Коробка с зажигалкой
uplink-contraband-lighter-desc = Таинственная коробка, которая гарантированно содержит фирменную зажигалку синдиката. Топливо не требуется.
uplink-smuggler-satchel-name = Сумка контрабандиста
uplink-smuggler-satchel-desc = Удобная, подозрительно выглядящая сумка. Достаточно плоская, чтобы поместиться под плиткой на полу.
uplink-acolyte-armor-name = Броня аколита
uplink-acolyte-armor-desc = Предмет, который должен быть у любого уважающего себя лидера культа. Зловещего вида доспехи, сделанные из костей и на удивление устойчивые к повреждениям.
