...
tape-cassette-position = Кассета имеет размер около [color=зеленый]{ $position }%[/color] путь до конца.
tape-cassette-damaged = Кассета размотана, почините ее с помощью ручки или отвертки.
tape-recorder-playing = Магнитофон находится в режиме воспроизведения [цвет=зеленый][/color].
...
tape-recorder-rewinding = Магнитофон находится в режиме [color=желтый] перемотки [/color].
tape-recorder-locked = Невозможно извлечь устройство во время работы магнитофона.
tape-recorder-voice-unknown = Неизвестный
tape-recorder-voice-unintelligible = Невразумительный
...
tape-recorder-print-start-text = [выделено жирным шрифтом]Начало записанной расшифровки[/выделено жирным шрифтом]
tape-recorder-print-message-text = [выделено жирным шрифтом][{ $time }] { $source }: [/выделено жирным шрифтом] { $message }
tape-recorder-print-end-text = [выделено жирным шрифтом]Конец записанной стенограммы[/выделено жирным шрифтом]
